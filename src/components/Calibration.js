  ...
  render() {
    ...
    switch (this.state.calibrationState) {
      ...
      case 'record':
        let cameraCircle;
        if (
          this.state.videoFeedbackState === 'waitRecord' ||
          this.state.videoFeedbackState === 'stopRecord'
        ) {
              ...
              <div className="col-12">
                ...
                <div className="row justify-content-center">
                  <div className="col-12 visual-analog-scale">
                    <div className="mediaTestingQuestion ">
                      {videoIntro.listItem[3]}
                    </div>
                    <div className="mediaTestingQuestion font-weight-bold">
                      "{videoIntro.listItem[4]}"
                    </div>
                  </div>
                </div>
              </div>
