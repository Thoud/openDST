                  ...
                  <div className="col-6">
                    <FormControl>
                      <InputLabel id="demo-simple-select-label">
                        {i18next.t('genderAndAge.formControll.gender')}
                      </InputLabel>
                      <Select
                        style={selectForms}
                      ...
                      >
                        <MenuItem value={'male'}>
                          {i18next.t('genderAndAge.formControll.male')}
                        </MenuItem>
                        <MenuItem value={'female'}>
                          {i18next.t('genderAndAge.formControll.female')}
                        </MenuItem>
                        <MenuItem value={'other'}>
                          {i18next.t('genderAndAge.formControll.others')}
                        </MenuItem>
                      </Select>
                    </FormControl>
                    <TextField
