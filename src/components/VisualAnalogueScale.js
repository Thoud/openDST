        ...
        <div className="row justify-content-center align-items-center">
          <div className="p-2">
            <Button
              ...
              onClick={() => {
                if (
                  this.state.allInputsChanged === true ||
                  this.state.showWarning
                ) {
                  this.props.handBackStressData(
                    this.state.moodInput,
                    this.props.stressImpression,
                  );
      ...
      <>
        ...
        <div className="row text-center justify-content-center">
          <div className="container-fluid">
            <div className="p-2">
              {this.state.showWarning ? (
                <div className="feedbackVAS">{i18next.t('warnungVAS')}</div>
              ) : null}
            </div>
            {endingButton}
          </div>
