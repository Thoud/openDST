...
class NumberInputField extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    if (
      this.props.numberInputLayoutIsRandom !==
      prevProps.numberInputLayoutIsRandom
    ) {
      this.setNumberPad(this.props.numberInputLayoutIsRandom);
    }
  }
          ...
          <div className="col-md-12">
            ...
            <div className="row justify-content-end">
              <div className="col-12 p-1">
                <button
                  type="button"
                  id={this.state.buttonStack[9]}
                  className={this.state.buttonState}
                  onClick={this.props.handleNumberInput}
                  disabled={this.props.isDisabled}
                >
                  {this.state.buttonStack[9]}
                </button>
              </div>
            </div>
          </div>
