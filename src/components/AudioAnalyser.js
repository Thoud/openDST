...
class AudioAnalyser extends Component {
  ...
  setupAudioWave() {
    ...
    this.dataArrayTD = new Uint8Array(
      this.analyserTimeDomain.frequencyBinCount,
    );
    this.dataArrayFD = new Uint8Array(
      this.analyserFrequencyDomain.frequencyBinCount,
    );
  ...
  getMeanVolume() {
    if (this.props.state === 'recording') {
      this.props.volumeCallback(
        this.checkAudioStreamForInput(this.dataArrayFD).mean,
      );
    }
  }
