  ...
  render() {
    return (
      <div className="darken-background">
        <Slide
          direction="right"
          in={this.props.activeSlide === 'transition'}
          mountOnEnter
          unmountOnExit
        >
          <Transition
                ...
                <div className="row">
                  <div className="col-12">
                    <ul className="list-styled ul stepper-bullet-point">
                      <li className="pb-1">
                        {i18next.t('speechTaskTutorial.task.text_0')}
                      </li>
                      <li className="pb-1">
                        {i18next.t('speechTaskTutorial.task.text_1.text_0')}
                        <strong>
                          {i18next.t('speechTaskTutorial.task.text_1.text_1')}
                        </strong>
                        {i18next.t('speechTaskTutorial.task.text_1.text_2')}
                        <u>
                          {i18next.t('speechTaskTutorial.task.text_1.text_3')}
                        </u>
                        {i18next.t('speechTaskTutorial.task.text_1.text_4')}
                        <u>
                          {i18next.t('speechTaskTutorial.task.text_1.text_5')}
                        </u>
                      ...
                      <li className="pb-1">
                        ...
                        <strong>
                          {i18next.t('speechTaskTutorial.task.text_2.text_1')}
                        </strong>
                        {i18next.t('speechTaskTutorial.task.text_2.text_2')}
                      </li>
                      <li className="pb-1">
                        {i18next.t('speechTaskTutorial.task.text_3')}
                      </li>
                    </ul>
                  </div>
                </div>
