...
class Introduction extends React.Component {
    ...
    this.contentList = [
      process.env.REACT_APP_LOGGING === 'true'
        ? {
            ...
            listItem: [
              i18next.t('study_introduction_0.text0'),
              i18next.t('study_introduction_0.text1'),
              i18next.t('study_introduction_0.text2'),
            ],
          }
        : {
            header: <u> {i18next.t('study_introduction_0.header')} </u>,
            listItem: [
              ...
              i18next.t('study_introduction_0.text1'),
              i18next.t('study_introduction_0.text2'),
              <b>{i18next.t('study_introduction_0.text3')}</b>,
            ],
          },
      {
        header: <u> {i18next.t('study_introduction_1.header')} </u>,
        listItem: [
          i18next.t('study_introduction_1.text0_1'),
          i18next.t('study_introduction_1.text0_2'),
          i18next.t('study_introduction_1.text0_3'),
          i18next.t('study_introduction_1.text0_4'),
          i18next.t('study_introduction_1.text0_5'),
        ],
      },
      {
        header: <u> {i18next.t('study_introduction_2.header')} </u>,
        listItem: [
          i18next.t('study_introduction_2.text0_1'),
          i18next.t('study_introduction_2.text0_2'),
          i18next.t('study_introduction_2.text0_3'),
          i18next.t('study_introduction_2.text0_4'),
        ],
      },
      {
        header: <u> {i18next.t('study_introduction_3.header')} </u>,
        listItem: [
          i18next.t('study_introduction_3.text1'),
          i18next.t('study_introduction_3.text1_1'),
          i18next.t('study_introduction_3.text2'),
          i18next.t('study_introduction_3.text3'),
          i18next.t('study_introduction_3.text3_2'),
          i18next.t('study_introduction_3.text4'),
          <div>
  ...
  checkProceeding() {
    if (
      !this.state.checkBoxBackground ||
      !this.state.checkBoxInfo ||
      !this.state.checkBoxProcessing ||
      !this.state.checkBoxConfirm
    ) {
  ...
  render() {
    ...
    for (
      let i = 0;
      i < this.contentList[this.state.infoCounter].listItem.length;
      ++i
    ) {
      arrayOfListElements.push(
        <li className="pb-1" key={i}>
          {this.contentList[this.state.infoCounter].listItem[i]}
        </li>,
      );
    }
    return (
      <>
        <Slide
          direction="right"
          in={this.props.activeSlide === 'intro'}
          mountOnEnter
          unmountOnExit
        >
          <div>
                  ...
                  <p>
                    {this.props.language === 'de' ? (
                      <a
                        ...
                        href={
                          process.env.REACT_APP_ADDITIONAL_INFORMATION_URL_DE
                        }
                      >
                        {i18next.t('study_introduction_3.additional_info')}
                      </a>
                    ) : (
                      <a
                        className="additionalInfo"
                        href={
                          process.env.REACT_APP_ADDITIONAL_INFORMATION_URL_EN
                        }
                      >
                        {i18next.t('study_introduction_3.additional_info')}
                      </a>
            ...
            {this.state.infoCounter === 0 ? (
              <CheckboxForPriorParticipation
                handlerCheckBoxForPriorParticipation={
                  this.props.handlerCheckBoxForPriorParticipation
                }
              />
            ) : (
              <div />
        ...
        <Slide
          direction="right"
          in={this.props.activeSlide === 'consent'}
          mountOnEnter
          unmountOnExit
        >
          <div>
                    ...
                    <RadioGroup className="justify-content-start">
                      <div className=" text-left justify-content-start pb-3">
                        <FormControlLabel
                          ...
                          control={
                            <Checkbox
                              checked={this.state.checkBoxBackground}
                              onChange={this.handleChange}
                              name="checkBoxBackground"
                            />
                          }
                          label={i18next.t(
                            'study_introduction_3_5.consensus_0',
                          )}
                        />
                      </div>
                      <div className=" text-left justify-content-start pb-3">
                          ...
                          label={
                            <div>
                              ...
                              {this.props.language === 'de' ? (
                                ...
                                >
                                  {i18next.t(
                                    'study_introduction_3_5.consensus_3b',
                                  )}
                                </a>
                              ) : (
                                <a
                      ...
                      <div className="pb-3">
                        <FormControlLabel
                          ...
                          control={
                            <Checkbox
                              checked={this.state.checkBoxProcessing}
                              onChange={this.handleChange}
                              name="checkBoxProcessing"
                            />
                          }
                          label={i18next.t(
                            'study_introduction_3_5.consensus_1',
                          )}
                        />
                      </div>
                      <div className="pb-3 font-weight-bold">
                        <FormControlLabel
                          ...
                          control={
                            <Checkbox
                              checked={this.state.checkBoxConfirm}
                              onChange={this.handleChange}
                          ...
                          label={
                            <b>
                              {' '}
                              {i18next.t(
                                'study_introduction_3_5.consensus_2',
                              )}{' '}
                            </b>
                          }
                        />
        ...
        <Slide
          direction="right"
          in={this.props.activeSlide === 'panas'}
          mountOnEnter
          unmountOnExit
        >
          <Panas
        ...
        <Slide
          direction="right"
          in={this.props.activeSlide === 'calibration'}
          mountOnEnter
          unmountOnExit
        >
          <Calibration
